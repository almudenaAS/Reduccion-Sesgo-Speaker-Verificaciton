...
parser.add_argument('--sesgo', type=str)
parser.add_argument('--save_path_cal_scores', type=str)
parser.add_argument('--save_path_cal_emb1', type=str)
# parser.add_argument('--save_path_cal_emb2', type=str)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.eval == True:
        ...
        sc, lab, _, Testemebddings = trainer.evaluateFromList(**vars(args))
        
        ### 
        if args.gpu == 0:
            scoresTest.append(sc)
        ...
        print('\n Seve Scores y emebddings \n')
        numpy.save(args.save_path_cal_scores+'/scoresTest_'+args.sesgo+'.npy', sc)
        numpy.savez(args.save_path_cal_emb1+'/labTest_'+args.sesgo+'.npz', lab)
    ...
    if args.eval == False:
        ...
        for it in range(it,args.max_epoch+1):
            ...
            loss, traineer, embedding = trainer.train_network(train_loader, verbose=(args.gpu == 0));
            ...
            if it % args.test_interval == 0:
                ...
                sc, lab, _, embeddingsTest = trainer.evaluateFromList(**vars(args))
                scoresTrain.append(sc)
                labs.append(lab)
                ...
                if args.gpu == 0:
                    ...
                    print('\n Seve Scores y emebddings \n')    
                    numpy.save(args.save_path+'/scoresTrain.npy', scoresTrain)     
                    numpy.savez(args.save_path+'/lab_Train.npz', labs)
