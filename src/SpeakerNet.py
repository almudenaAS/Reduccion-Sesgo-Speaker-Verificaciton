...
class SpeakerNet(nn.Module):
    ...
    def forward(self, data, label=None):
        ...
        # Este auptput es la capa de embeddinds Los X Vector,
        # los que tenemos que tener en cuenta para el entreanmiento del calibrador AJAJAJAJ
        # In this code, `outp` is the output of the `SpeakerNetModel` and represents the embedding cape.
