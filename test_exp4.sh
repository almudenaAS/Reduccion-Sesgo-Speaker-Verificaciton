...
model=ResNetSE34L
initial_model=exp/exp4_FairVoice/model/model000000400.model
encoder_type=SAP
trainfunc=amsoftmax
save_path=exps/exp4_FairVoice
...
save_path_cal_scores=exps/exp4_FairVoice/scores
save_path_cal_emb1=exps/exp4_FairVoice/labels
nameSesgos=general
python ./trainSpeakerNet.py --eval --model $model --log_input True \
                         ...
                         --nClasses 6227 --sesgo $nameSesgos \
