...
#$ -o /mnt/audias_data/users/aaguilera/voxceleb_trainer/qsub_exp4Outs2
#$ -e /mnt/audias_data/users/aaguilera/voxceleb_trainer/qsub_exp4Error2
...
CUDA_VISIBLE_DEVICES=${free_gpus:0:$((${ngpus}*2-1))} python $1 \
        --model $model \
        --log_input True \
        --trainfunc $trainfunc \
        --save_path $save_path \
